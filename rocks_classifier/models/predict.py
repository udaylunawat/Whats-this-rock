"""Predict function for telegram bot."""
...
_doc_ = """Predict function for telegram bot."""
...
def get_run_data():
    ...
    runs = sorted(
        sweep.runs, key=lambda run: run.summary.get("val_accuracy", 0), reverse=True
    )
...
def get_prediction(file, cfg, class_names):
...
# %% ../../notebooks/03_e_predict.ipynb 4
# | eval: false
