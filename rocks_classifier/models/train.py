...
_doc_ = """Trains a model on rocks dataset."""
...
from rocks_classifier.models.utils import (
    get_lr_scheduler,
    get_model_weights,
    get_optimizer,
)
from rocks_classifier.visualization.plot import (
