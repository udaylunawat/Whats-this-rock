...
# setting up data dir
rm -rf data/1_extracted data/2_processed data/3_tfds_dataset data/corrupted_images data/bad_images
mkdir -p data/0_raw data/1_extracted data/2_processed data/3_tfds_dataset data/corrupted_images data/bad_images checkpoints
