...
def print_in_color(
    ...
    # prints the text_msg in the foreground color
    # specified by fore_tupple with the background specified by back_tupple
...
class LRA(tf.keras.callbacks.Callback):
    ...
    def __init__(
        ...
        self.dwell = dwell
        self.lr = float(
            K.get_value(model.optimizer.lr.initial_learning_rate)
